...
Хвала сообществу Python, уже и не надо, так как мы официально больше не поддерживаем вторую версию.
...
#### `TZ=UTC`, отличается от часового пояса строки для `strptime()`
```
==TZ=UTC 1587914590==
now: [1587914590, 0]
utcnow: [1587914590, 0]
